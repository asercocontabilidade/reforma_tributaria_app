...
function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl rounded-2xl border border-gray-200 bg-white p-4 shadow-xl dark:border-white/10 dark:bg-[#0f0e2f]">
...
export default function CompaniesPage() {
  ...
  return (
    <div className="p-4 md:p-6">
            ...
            {companies.map((c) => {
              ...
              return (
                <tr key={c.id} className="card dark:bg-[#0f0e2f] align-top">
                  ...
                  <td className="px-3 py-2 text-sm">{new Date(c.contract_start_date).toLocaleDateString()}</td>
                  <td className="px-3 py-2 text-sm">{new Date(c.contract_end_date).toLocaleDateString()}</td>
      ...
      <CreateCompanyDialog open={openCreate} onClose={() => setOpenCreate(false)} onCreated={loadCompanies} />
